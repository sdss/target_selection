...
class append_to_tables:
    ...
    def create_temp_catalogid_lists(self, database, output_name):
        ...
        v21_cid_query_y = (
            ...
            .join(
                Catalog,
                on=(
                    (Catalog.catalogid == TempMatch.catalogidy) & (Catalog.lead == TempMatch.lead)
                ),
            )
            .switch(TempMatch)
            .join(
    ...
    def create_sdss_id_stacked_to_add(self, database, output_name):
        ...
        ra_dec_update31 = (
            sdss_id_stacked_to_add.update(ra_sdss_id=Catalog.ra, dec_sdss_id=Catalog.dec)
            .from_(Catalog)
    ...
    def add_to_sdss_id_stacked(self, database):
        ...
        to_add = sdss_id_stacked_to_add.select(
    ...
    def create_sdss_id_flat_to_add(self, database):
        ...
        sid_flat_add_v21 = (
            ...
            .where(sdss_id_stacked.sdss_id > max_sdss_id)
            .tuples()
        )
        ...
        cte = (
            sdss_id_flat_to_add.select(sdss_id_flat_to_add.catalogid, fn.COUNT("*").alias("ct"))
        ...
        (
            sdss_id_flat_to_add.update(ra_catalogid=Catalog.ra, dec_catalogid=Catalog.dec)
            .from_(Catalog)
    ...
    def add_to_sdss_id_flat(self, database):
        ...
        to_add = sdss_id_flat_to_add.select(
            sdss_id_flat_to_add.sdss_id,
            sdss_id_flat_to_add.catalogid,
            sdss_id_flat_to_add.version_id,
            sdss_id_flat_to_add.ra_sdss_id,
            ...
            sdss_id_flat_to_add.dec_catalogid,
        ).tuples()
