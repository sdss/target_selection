...
\citealt{Waddel2026}. The X-ray sources have been cross-matched by the
eROSITA-DE team to
...
measurements between each independent 6-month eROSITA sky survey. All
targets are located in the sky hemisphere where MPE controls the data
rights (approx. 180\textless{}\emph{l}\textless360~deg).
