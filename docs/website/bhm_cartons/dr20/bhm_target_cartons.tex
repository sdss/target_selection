...
\noindent\textbf{Summary:} A supporting sample of candidate QSOs detected via
X-ray imaging in the Reverberation Mapping fields.

\noindent\textbf{Simplified description of selection criteria:} TODO
...
and whether they are within the \textquotesingle core\textquotesingle{}
...
magnitude range (i.e. doesn\textquotesingle t satisfy one of
...
the first 6~months of eROSITA all sky survey data (eRASS:1). The X-ray
...
outside the core magnitude range (i.e. doesn\textquotesingle t satisfy
one of 16.5\textless{}\texttt{fibermag\_r}\textless22.0 or
16.5\textless{}\texttt{fibermag\_i}\textless21.8 or
...
range (i.e. doesn\textquotesingle t satisfy
16.0\textless{}\emph{G}\textless21.0), e) the target lies at
\textbar{}\emph{b}\textbar\textless15~deg or at Dec\textless-75~deg, f)
the X-ray flux is
\textless2x10\textsuperscript{-14}~erg~s\textsuperscript{-1}~cm\textsuperscript{-2}.
We slightly boost the priorities of targets which have hard X-ray
...
transient/variable X-ray sources. All targets are located in the sky
hemisphere where MPE controls the data rights (approx.
180\textless{}\emph{l}\textless360~deg), and .
...
first N eROSITA All Sky surveys, which have been associated with
LegacySurvey DR10 counterparts (method: NWAY assisted by optical/IR
priors computed via a pre-trained Random Forest, building on
...
\noindent\textbf{Summary:} This is a small supplementary catalog of eROSITA X-ray
sources detected in the South Ecliptic Pole (SEP) field, a part of the
sky which has the deepest eROSITA data. This carton provides optical
counterparts to point-like (unresolved) X-ray sources detected in early
reductions of the complete eROSITA survey data set (eRASS:5) within an
approximately 7x7~deg sky region around the SEP. The X-ray sources have
been cross-matched by the eROSITA-DE team to Gaia DR3 optical
counterparts.

\noindent\textbf{Simplified description of selection criteria:} Starting from a
parent catalog of eRASS:5 point source $\rightarrow$ Gaia DR3 associations, select
targets which meet all of the following criteria: i) have eROSITA
detection likelihood\textgreater6.0, ii) have an X-ray$\rightarrow$Gaia cross-match
probability of \texttt{p\_any}\textgreater0.1, iii) have
\emph{G}\textgreater13.5 and \emph{RP}\textgreater13.5~Vega. We
...
X-ray$\rightarrow$Gaia association, d) the target falls outside the core magnitude
range (i.e. doesn\textquotesingle t satisfy
16.0\textless{}\emph{G}\textless21.5), e) the X-ray flux is
...
\texttt{type} != \textquotesingle PSF\textquotesingle, ii) lsdr10
...
PanSTARRS1 counterparts); 14.0 \textless{} \emph{G}\textless20.0~Vega
(Gaia DR3 counterparts). De-prioritize targets which already have good
quality SDSS spectroscopy. The \textquotesingle\_d3\textquotesingle{}
...
and whether they are within the \textquotesingle core\textquotesingle{}
16\textless{}\texttt{fibertotmag\_i}\textless20.5 or
16\textless{}\texttt{fibertotmag\_z}\textless20.0~AB). The
\textquotesingle\_d3\textquotesingle{} variation of this carton provides
...
\textless2x10\textsuperscript{-14}~erg~s\textsuperscript{-1}~cm\textsuperscript{-2}.
We slightly boost the priorities of targets which have hard X-ray
detections. The \textquotesingle\_d3\textquotesingle{} variation of this
carton provides a shallower cadence option for targets toward the
...
\noindent\textbf{Summary:} A supplementary catalog of eROSITA X-ray sources
detected in the South Ecliptic Pole (SEP) field, a part of the sky which
has the deepest eROSITA data. This carton provides optical counterparts
to point-like (unresolved) X-ray sources detected in early reductions of
the complete eROSITA survey data set (eRASS:5) within an approximately
7x7~deg sky region around the SEP. The X-ray sources have been
cross-matched by the eROSITA-DE team to Gaia DR3 optical counterparts.
...
optical spectroscopic measurements. Note that the selection criteria are
based on apparent magnitudes, rather than the dereddened magnitudes that
were used in an earlier iteration of this carton. The
\textquotesingle\_d3\textquotesingle{} variation of this carton provides
a shallower cadence option for targets in this sample.
...
\noindent\textbf{Summary:} This carton provides optical counterparts to
point-like (unresolved) hard-band (2.3-5~keV) X-ray sources detected in
the first 6~months of eROSITA all sky survey data (eRASS:1). The X-ray
sources have been cross-matched by the eROSITA-DE team to
\href{https://www.legacysurvey.org/dr10/}{LegacySurvey DR10} optical/IR
...
\textbar{}\emph{b}\textbar\textless10~deg or at Dec\textless-75~deg.
Cadence choices (exposure time requests per target) are based on optical
brightness. The \textquotesingle\_d3\textquotesingle{} variation of this
carton provides a shallower cadence option for targets in this sample.
...
\noindent\textbf{Simplified description of selection criteria:}
...
\noindent\textbf{Implementation:}
\href{https://github.com/sdss/target_selection/blob/1.3.3/python/target_selection/cartons/}{}
...
\emph{G}\textgreater15.0~ and \emph{RP}\textgreater15.0~Vega, vii) at
moderate to high Galactic latitude
\textbar{}\emph{b}\textbar\textgreater15~deg. The
\textquotesingle\_d3\textquotesingle{} variation of this carton provides
a shallower cadence option for targets toward the optically faint end of
the sample.
