    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (CatalogToGaia_DR3
                 ...
                 .where(CatalogToGaia_DR3.version_id == version_id,
                        ...
                        (Gaia_DR3.parallax <
                         peewee.fn.power(10, ((10.0 - TwoMassPSC.ks_m + 0.0) / 5.0))),
                        (Gaia_DR3.parallax >
                         peewee.fn.power(10, ((10.0 - TwoMassPSC.ks_m - 0.61) / 5.0))),
                        Gaia_DR3.phot_g_mean_mag < 16,
                        (TwoMassPSC.j_m - TwoMassPSC.ks_m
                         - 0.25 * (Gaia_DR3.phot_g_mean_mag - TwoMassPSC.ks_m) < 0.10),
                        (TwoMassPSC.j_m - TwoMassPSC.ks_m
                         - 0.25 * (Gaia_DR3.phot_g_mean_mag - TwoMassPSC.ks_m) > -0.30),
