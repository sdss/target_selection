...
class MWM_YSO_OB_APOGEE_Single_Carton(MWM_YSO_OB_APOGEE_Carton):
    name = 'mwm_yso_ob_apogee_single'
    cadence = 'bright_1x1'
    priority = 2706
...
class MWM_YSO_OB_BOSS_Single_Carton(MWM_YSO_OB_BOSS_Carton):
    name = 'mwm_yso_ob_boss_single'
    cadence = 'bright_1x1'
    priority = 2706
    instrument = 'BOSS'
