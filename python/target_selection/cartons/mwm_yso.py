...
#  w3mpro-w4mpro>(w1mpro-w2mpro)*0.8+1.1
    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (Catalog
                 ...
                 .join(AllWise)
                 .where(AllWise.h_m_2mass < 13,
                        Gaia_DR2.phot_g_mean_mag > 18.5 or
                        Gaia_DR2.phot_g_mean_mag is null,
                        (AllWise.j_m_2mass - AllWise.h_m_2mass) > 1.0,
                        (AllWise.h_m_2mass - AlllWise.k_m_2mass) > 0.5,
...
#(b>-5 or l>180) and b<-5
    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (Catalog
                 ...
                 .join(AllWise)
                 .where(AllWise.h_m_2mass < 13,
                        ((AllWise.w2mpro - AllWise.w3mpro) > 4 and
                         AllWise.w4mpro is null) or
                        (AllWise.w3mpro is null and
                         AllWise.w4mpro is null and
                         (AllWise.j_m_2mass - AllWise.h_m_2mass) > 1.1),
                        ((Gaia_DR2.b > -5) and (Gaia_DR2.b < 5)) or
                        ((Gaia_DR2.b < -5) and (Gaia_DR2.l > 180))))
...
# sqrt(phot_rp_n_obs)/phot_rp_mean_flux_over_error>0.02
    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (Catalog
                 ...
                 .switch(TIC_v8)
                 .join(Gaia_DR2)
                 .where(Gaia_DR2.phot_g_mean_mag < 18.5,
                        TwoMassPSC.h_m < 13,
                        Gaia_DR2.parallax > 0.3,
...
# parallax>0.3
    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (Catalog
                 ...
                 .switch(TIC_v8)
                 .join(Gaia_DR2)
                 .where(TwoMassPSC.h_m < 13,
                        (Gaia_DR2.bp_rp > -0.2) and (Gaia_DR2.bp_rp < 1.1),
...
# REFERENCES twomass_psc(designation)
    ...
    def build_query(self, version_id, query_region=None):
        ...
        query = (Catalog
                 ...
                 .join(TwoMassPSC)
                 .join(MIPSGAL)
                 .where(MIPSGAL.hmag < 13,
                        (MIPSGAL.glon > 358) or (MIPSGAL.glon < 2),
                        (MIPSGAL.glat > -1) and (MISPSGAL.lat < 1),
                        (MIPSGAL.mag_8_0 - MIPSGAL.mag_24) > 2.5,
                        (Gaia_DR2.parallax < 0.2) or
                        (Gaia_DR2.parallax is null)))
