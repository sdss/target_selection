...
class OPS_Tycho_Brightneighbors_Carton(BaseCarton):
    ...
    cadence options for these targets (list all options, even though no single target will receive more than one): Null (since this is a veto catalog, we want cadence, value, priority and instrument to all be Null).  
