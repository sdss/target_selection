...
class MWM_Dust_Dist_Carton(BaseCarton):
    """MWM Dust Dist Carton.

    This is identical to the MWM_Dust_Carton, but depending on the
    mwm_galactic_core_dist rather than mwm_galactic_core carton.
    ...
    def build_query(self, version_id, query_region=None):
        ...
        gg_exists = (targetdb.Carton.select()
                     ...
                     .where(targetdb.Carton.carton == 'mwm_galactic_core_dist',
